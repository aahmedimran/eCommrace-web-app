...
const Profile = () => {
  ...
  return (
    <>
      {(editprofile !== null) ? (<div className='form-f'>

        <h1>Edit Profile</h1>
        <form onSubmit={updateHandler} >
          <label> First  Name</label>
          <br />
          <input type="text" value={editprofile?.firstName}
          ...
          <br />
          <input type="text" value={editprofile?.secondName}
            onChange={(e) => { seteditprofile({ ...editprofile, secondName: e.target.value }) }}
          ...
          <label>Age</label>
          <br />
          <input type="text" value={editprofile.age}
      ...
      <div className="user">
        <div className="user-second">
          ...
          <h1>Name : {state?.user?.firstName} {state?.user?.secondName}</h1>
