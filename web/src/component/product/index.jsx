...
const Addproduct = () => {
    ...
    return (
        <>
            <button className='addmain' onClick={() => {

                setaddProduct(true)


            }}
            ><FcPlus className='addicon' /></button>
            {(addProduct !== null) ?
                        ...
                        <form onSubmit={formik.handleSubmit}>
                            ...
                            />
                            {
                                (formik.touched.discription && formik.errors.discription) ?
                                    <div className="errorMessage">{formik.errors.discription}</div> : null
                            }
                            <br />
                            ...
                            />
                            {
                                (formik.touched.quantity && formik.errors.quantity) ?
                                    <div className="errorMessage">{formik.errors.quantity}</div> : null
                            }
                            <br />
                            ...
                            />
                            {
                                (formik.touched.file && formik.errors.file) ?
                                    <div className="errorMessage">{formik.errors.file}</div> : null
                            }
                            <br />
                            <button type="submit"
                            >
            ...
            {(editProduct !== null) ? (<div>
                ...
                <form onSubmit={updateHandler}>
                    Name: <input className='input-type' type="text" value={editProduct.name}
                        onChange={(e) => { seteditProduct({ ...editProduct, name: e.target.value }) }}
                    />

                    <br />
                    <input className='input-type' type="text" value={editProduct.discription}
                        onChange={(e) => { seteditProduct({ ...editProduct, discription: e.target.value }) }}

                    />

                    <br />
                    <input className='input-type' type="text" value={editProduct.price}
                                ...
                                <div className='_btn'>
                                    {
                                        state?.cart.some((p) => p._id === eachgetproduct._id) ? (
                                            ...
                                            (
                                                <button className='btn_style_edi'
                                                    onClick={() => addToCard(eachgetproduct)}>Add to cart</button>
                                            )
                                    }
                                    <button className='Checkout' onClick={() => addToCard(eachgetproduct)}>Checkout</button>
                                </div>
                            </>
